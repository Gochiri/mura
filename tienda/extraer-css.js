...
const cabecera = [
  ...
  '',
  '   VA EN: cada página de tienda → Settings → Custom CSS',
  '     /checkout · /products-list · /product-details · /thank-you',
  '',
  '   Se pega en las cuatro. Esa caja es por página y no hay una',
  '   global; el Tracking Code del Head no vale porque GHL no lo',
  '   sirve dentro del <head>, lo inyecta por JS cuando ya arrancó.',
  '',
